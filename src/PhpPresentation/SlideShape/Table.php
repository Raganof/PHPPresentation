...
use PhpOffice\PhpPresentation\SlideShape\Table\Row;
...
class Table extends AbstractGraphic implements ComparableInterface
{
     ...
     * Rows
     *
     * @var \PhpOffice\PhpPresentation\SlideShape\Table\Row[]
     */
    private $rows;
    ...
    /**
     * Create a new \PhpOffice\PhpPresentation\SlideShape\Table instance
     *
